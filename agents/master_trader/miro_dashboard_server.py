...
.side{border-right:1px solid var(--line);background:rgba(8,10,12,.88);padding:18px 12px;position:sticky;top:0;height:100vh;overflow-y:auto;scrollbar-width:thin;scrollbar-color:var(--line2) transparent}
...
.nav{display:grid;gap:8px;margin-top:14px;padding-bottom:90px}.nav-group{border:1px solid rgba(39,49,59,.76);border-radius:10px;background:rgba(12,17,22,.72);overflow:hidden}.nav-group summary{list-style:none;cursor:pointer;padding:10px;display:grid;gap:2px}.nav-group summary::-webkit-details-marker{display:none}.nav-group summary span{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.1em;font-weight:700;color:var(--text);line-height:1.2}.nav-group summary small{display:block;color:var(--muted);font-size:10px;line-height:1.25;margin-top:2px}.nav-group[open] summary{border-bottom:1px solid rgba(39,49,59,.72);background:linear-gradient(180deg,rgba(21,27,34,.96),rgba(13,18,23,.96))}.nav a{display:block;color:var(--soft);text-decoration:none;padding:8px 10px;margin:5px 6px;border:1px solid transparent;border-radius:6px}
.nav a.active,.nav a:hover{background:var(--panel2);border-color:var(--line);color:var(--text)}
.side-foot{position:sticky;bottom:0;background:linear-gradient(180deg,transparent,#080a0c 24%);padding-top:18px;color:var(--muted);font-family:var(--mono);font-size:11px;line-height:1.6}
...
<div class="shell">
  <aside class="side">
    ...
    <nav class="nav">
      <details class="nav-group" open><summary><span>Monitor</span><small>Usually watch during trading.</small></summary>
      ...
      <details class="nav-group"><summary><span>Records</span><small>Audit what happened and why.</small></summary>
        <a href="/trade-journal">Trade Journal</a><a href="/risk-timeline">Risk Timeline</a><a href="/agent-memory">Agent Memory</a>
      </details>
      <details class="nav-group"><summary><span>Setup</span><small>Environment and old UI.</small></summary>
        <a href="/setup">Setup Wizard</a><a href="/legacy">Legacy Dashboard</a>
      </details>
      <details class="nav-group"><summary><span>API</span><small>Raw state endpoints.</small></summary>
        <a href="/api/miro">API State</a><a href="/api/autonomy">Autonomy API</a>
      </details>
    </nav>
    <div class="side-foot">
...
.shell{display:grid;grid-template-columns:250px minmax(0,1fr);min-height:100vh}.side{border-right:1px solid var(--line);background:rgba(8,10,12,.9);padding:18px 12px;position:sticky;top:0;height:100vh;overflow-y:auto;scrollbar-width:thin;scrollbar-color:var(--line2) transparent}.brand{display:flex;align-items:center;gap:10px;margin-bottom:18px}.mark{width:34px;height:34px;border:1px solid var(--line2);display:grid;place-items:center;background:#10171d;color:var(--green);font-weight:700}.brand h1{font-size:15px;margin:0;letter-spacing:.08em}.brand p{margin:2px 0 0;color:var(--muted);font-size:11px}.nav{display:grid;gap:8px;margin-top:14px;padding-bottom:90px}.nav-group{border:1px solid rgba(39,49,59,.76);border-radius:10px;background:rgba(12,17,22,.72);overflow:hidden}.nav-group summary{list-style:none;cursor:pointer;padding:10px;display:grid;gap:2px}.nav-group summary::-webkit-details-marker{display:none}.nav-group summary span{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.1em;font-weight:700;color:var(--text);line-height:1.2}.nav-group summary small{display:block;color:var(--muted);font-size:10px;line-height:1.25;margin-top:2px}.nav-group[open] summary{border-bottom:1px solid rgba(39,49,59,.72);background:linear-gradient(180deg,rgba(21,27,34,.96),rgba(13,18,23,.96))}.nav a{display:block;color:var(--soft);text-decoration:none;padding:8px 10px;margin:5px 6px;border:1px solid transparent;border-radius:6px}.nav a.active,.nav a:hover{background:var(--panel2);border-color:var(--line);color:var(--text)}.side-foot{position:sticky;bottom:0;background:linear-gradient(180deg,transparent,#080a0c 24%);padding-top:18px;color:var(--muted);font-family:var(--mono);font-size:11px;line-height:1.6}
...
.shell{display:grid;grid-template-columns:250px minmax(0,1fr);min-height:100vh}
.side{border-right:1px solid var(--line);background:rgba(8,10,12,.9);padding:18px 12px;position:sticky;top:0;height:100vh;overflow-y:auto;scrollbar-width:thin;scrollbar-color:var(--line2) transparent}.side::-webkit-scrollbar{width:6px}.side::-webkit-scrollbar-thumb{background:var(--line2);border-radius:99px}
.brand{display:flex;align-items:center;gap:10px;margin-bottom:18px}.mark{width:34px;height:34px;border:1px solid var(--line2);display:grid;place-items:center;background:#10171d;color:var(--green);font-weight:700}.brand h1{font-size:15px;margin:0;letter-spacing:.08em}.brand p{margin:2px 0 0;color:var(--muted);font-size:11px}
.nav{display:grid;gap:8px;margin-top:14px;padding-bottom:90px}.nav-group{border:1px solid rgba(39,49,59,.76);border-radius:10px;background:rgba(12,17,22,.72);overflow:hidden}.nav-group summary{list-style:none;cursor:pointer;padding:10px;display:grid;gap:2px}.nav-group summary::-webkit-details-marker{display:none}.nav-group summary span{display:block;font-size:11px;text-transform:uppercase;letter-spacing:.1em;font-weight:700;color:var(--text);line-height:1.2}.nav-group summary small{display:block;color:var(--muted);font-size:10px;line-height:1.25;margin-top:2px}.nav-group[open] summary{border-bottom:1px solid rgba(39,49,59,.72);background:linear-gradient(180deg,rgba(21,27,34,.96),rgba(13,18,23,.96))}.nav a{display:block;color:var(--soft);text-decoration:none;padding:8px 10px;margin:5px 6px;border:1px solid transparent;border-radius:6px;font-size:13px;line-height:1.25}.nav a.active,.nav a:hover{background:var(--panel2);border-color:var(--line);color:var(--text)}
.side-foot{position:sticky;bottom:0;background:linear-gradient(180deg,transparent,#080a0c 24%);padding-top:18px;color:var(--muted);font-family:var(--mono);font-size:11px;line-height:1.6}
...
SCOREBOARD_HTML = r"""<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MIRO Scoreboard</title><style>body{margin:0;background:#0b0d10;color:#e9edf1;font-family:Arial,sans-serif;padding:18px}.nav{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:16px}.nav a{color:#b5c0cc;text-decoration:none;border:1px solid #27313b;border-radius:999px;padding:7px 10px}.nav a.active,.nav a:hover{color:#e9edf1;background:#151b22}.grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px}.card{background:#11161b;border:1px solid #27313b;border-radius:10px;padding:16px}.label{color:#8b98a6;font-size:11px;text-transform:uppercase}.value{font-size:28px;font-weight:700;margin-top:6px}.green{color:#2fd17c}.red{color:#f05252}.amber{color:#e6ad32}@media(max-width:900px){.grid{grid-template-columns:1fr}}</style></head><body><div class="nav"><a href="/">Command</a><a href="/operations">Operations</a><a class="active" href="/scoreboard">Scoreboard</a><a href="/strategy-lab">Strategy Lab</a><a href="/risk-timeline">Risk Timeline</a><a href="/pipeline">Pipeline</a><a href="/rules">Rules</a><a href="/legacy">Legacy</a></div><h1>Paper Trading Scoreboard</h1><div class="grid" id="grid"></div><script>
...
STRATEGY_LAB_HTML = r"""<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MIRO Strategy Lab</title><style>body{margin:0;background:#0b0d10;color:#e9edf1;font-family:Arial,sans-serif;padding:18px}.nav{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:16px}.nav a{color:#b5c0cc;text-decoration:none;border:1px solid #27313b;border-radius:999px;padding:7px 10px}.nav a.active,.nav a:hover{color:#e9edf1;background:#151b22}.panel{background:#11161b;border:1px solid #27313b;border-radius:10px;padding:14px;margin:12px 0}.row{display:grid;grid-template-columns:190px 130px 1fr;gap:10px;border-bottom:1px solid #27313b;padding:9px;font-family:monospace;font-size:12px}.pill{border:1px solid #344250;border-radius:999px;padding:3px 8px}.green{color:#2fd17c}.red{color:#f05252}.amber{color:#e6ad32}</style></head><body><div class="nav"><a href="/">Command</a><a href="/operations">Operations</a><a href="/scoreboard">Scoreboard</a><a class="active" href="/strategy-lab">Strategy Lab</a><a href="/risk-timeline">Risk Timeline</a><a href="/pipeline">Pipeline</a><a href="/rules">Rules</a><a href="/legacy">Legacy</a></div><h1>Strategy Lab</h1><div id="summary" class="panel">Loading...</div><div id="rows" class="panel"></div><script>
...
RISK_TIMELINE_HTML = r"""<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>MIRO Risk Timeline</title><style>body{margin:0;background:#0b0d10;color:#e9edf1;font-family:Arial,sans-serif;padding:18px}.nav{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:16px}.nav a{color:#b5c0cc;text-decoration:none;border:1px solid #27313b;border-radius:999px;padding:7px 10px}.nav a.active,.nav a:hover{color:#e9edf1;background:#151b22}.event{background:#11161b;border:1px solid #27313b;border-left:4px solid #42c6ff;border-radius:8px;padding:12px;margin:9px 0}.event.warn{border-left-color:#e6ad32}.event.red{border-left-color:#f05252}.meta{color:#8b98a6;font-family:monospace;font-size:12px}</style></head><body><div class="nav"><a href="/">Command</a><a href="/operations">Operations</a><a href="/scoreboard">Scoreboard</a><a href="/strategy-lab">Strategy Lab</a><a class="active" href="/risk-timeline">Risk Timeline</a><a href="/pipeline">Pipeline</a><a href="/rules">Rules</a><a href="/legacy">Legacy</a></div><h1>Risk Event Timeline</h1><div id="items">Loading...</div><script>
...
def _nav_groups():
    return [
        ("Monitor", "Usually watch these during trading.", [
            ("Command Center", "/"),
        ...
        ("Research", "Improve strategies before promotion.", [
            ("Strategy Lab", "/strategy-lab"),
            ("Simulation Lab", "/simulation-lab"),
        ]),
        ("Records", "Audit what happened and why.", [
            ("Trade Journal", "/trade-journal"),
            ("Risk Timeline", "/risk-timeline"),
            ("Agent Memory", "/agent-memory"),
        ]),
        ("Setup", "Environment, onboarding, and old UI.", [
            ("Setup Wizard", "/setup"),
...
def _page_nav(active):
    groups = []
    for group, hint, items in _nav_groups():
        is_open = any(label == active for label, _ in items) or group in {"Monitor", "Operate"}
        links = "".join(
            '<a class="{}" href="{}">{}</a>'.format("active" if key == active else "", href, key)
            for key, href in items
        )
        groups.append(
            '<details class="nav-group" {}><summary><span>{}</span><small>{}</small></summary>{}</details>'.format(
                "open" if is_open else "", group, hint, links
            )
        )
    groups.append('<details class="nav-group"><summary><span>API</span><small>Raw state endpoints.</small></summary><a href="/api/miro">API State</a><a href="/api/autonomy">Autonomy API</a></details>')
    return "".join(groups)
...
def legacy_dashboard():
    ...
    """
    return DASHBOARD_HTML.replace("<body>", "<body>" + legacy_nav, 1)
